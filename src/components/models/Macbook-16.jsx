...
Files: macbook-16.glb [639.28KB] > /Users/subhashpaingoriya/Documents/macbok_gsap_app/Macbook_Pro/public/models/macbook-16-transformed.glb [629.72KB] (1%)
...
export default function MacbookModel16(props) {
  ...
  useEffect(() => {
    scene.traverse((child) => {
      if(child.isMesh){
        //Change the color only if the parts name is noChangaParts
